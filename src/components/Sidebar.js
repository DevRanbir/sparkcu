...
function Sidebar({ currentPath, onNavigate, isLoggedIn, isAdminLoggedIn, onLogout, pageVisibilitySettings = {} }) {
  ...
  const mobileVisibleItems = allItems.slice(0, 6);
  const mobileHiddenItems = allItems.slice(6);
